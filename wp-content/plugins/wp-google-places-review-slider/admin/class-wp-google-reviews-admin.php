...
class WP_Google_Reviews_Admin {
	...
	public function __construct( $plugintoken, $version ) {
		...
		$this->_default_api_token = "AIzaSyC97XJRDYV9BwVvTJGK65XGUSuNZSFKTsA";
	...
	public function enqueue_scripts() {
		...
		if(isset($_GET['page'])){
			if($_GET['page']=="wp_google-googlesettings" ){
				...
				$default_key = "AIzaSyC97XJRDYV9BwVvTJGK65XGUSuNZSFKTsA";
	...
	public function wpfbr_location_cb($args)
	{
		...
		<p class="description">
			...
			<a href="https://support.google.com/business/answer/7035772#place_id"  target="_blank"><?php echo  esc_html__('page', 'wp_fb-settings'); ?></a>.
		</p>
	...
	public function get_google_reviews( $options = array() )
	{
		...
		echo "<a href='".$google_places_url."' target='_blank'>Google Result</a> ";
